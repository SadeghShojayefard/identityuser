...
export const claimsSchema = () => {
    return z.object({
        claimType: z
            .string({ error: "Please fill the claimType field first." })
        ...
        claimValue: z
            .string({ error: "Please fill the claimValue field first." })
        ...
        description: z
            .string({ error: "Please fill the Description field first." })
